    ...
    <footer className="bg-black text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-red-400">Sobre nosotros</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/games" className="hover:text-red-400 transition duration-300">
                  Biblioteca
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-red-400">Nuestras redes sociales</h3>
